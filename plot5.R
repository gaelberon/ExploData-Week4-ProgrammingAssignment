...
## The R file 'plot5.R' aims to answer the following question:
...
sumPerYear <- with(NEI[NEI$SCC %in% SCC[grep("vehicle",
                                             SCC$SCC.Level.Two,
...
################################################################################
## 3. Store the plot into the file plot5.png
dev.copy(png,
         file = 'plot5.png',
         width = 480,
         height = 480,
